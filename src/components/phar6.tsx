...
function Phar6() {
    ...
    // List of doctors
    const doctors = [
        { id: 1, name: "Arnoud Troost", image: Doctor1, image2: img1 ,description: "Lorem Ipsum", details: "It is a long established fact that a reader will be distracted by the readable content of a page." },
        { id: 2, name: "John Doe", image: Doctor2, image2: img2 , description: "Lorem Ipsum", details: "It is a long established fact that a reader will be distracted by the readable content of a page." },
        ...
        { id: 4, name: "Emily Johnson", image: Doctor4, image2: img4 , description: "Lorem Ipsum", details: "It is a long established fact that a reader will be distracted by the readable content of a page." },
        { id: 5, name: "Michael Brown", image: Doctor5,  image2: img5 ,description: "Lorem Ipsum", details: "It is a long established fact that a reader will be distracted by the readable content of a page." }
    ];
