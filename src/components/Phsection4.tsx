        ...
        <div className='pharmaciessecondsec4'>
            <Container className="distribution-sectionchng" maxWidth="xl">
                ...
                <div className="text-contentph">
                    ...
                    <b>Medask </b> LP Pharmacies support military hospitals like <b> CMH ,PEMH </b> and 
                    <b> AFIs </b> by providing essential medications through efficient local procurement. We ensure high-quality pharmaceutical products meet the specific needs of military healthcare facilities.Working closely with military medical teams, we fulfill local purchase needs with a comprehensive range of medications and supplies, ensuring critical medications are available for patient care.
                    </p>
                </div>
